                           ...
                           <ul class="list-unstyled">
                              <li>
                                 ...
                                 <div class="m-l-35 m-b-30">
                                    <small class="text-muted">SCHEDULED FOR 3:00 P.M. ON JUN 2024</small>
                              ...
                              <li>
                                 ...
                                 <div class="m-l-35 m-b-30">
                                    <small class="text-muted">SCHEDULED FOR 4:30 P.M. ON JUN 2024</small>
                                 </div>
                              </li>
                              <li>
                                 <label class="fancy-checkbox mb-0">
                                 ...
                                 <div class="m-l-35 m-b-30">
                                    <small class="text-muted">SCHEDULED FOR 4:30 P.M. ON JUN 2024</small><br>
                                 ...
                                 <div class="cwidget-scroll">
                                    <ul class="chat-widget m-r-5 clearfix">
                                       <li class="left float-left">
                                          ...
                                          <div class="chat-info">       
                                             <span class="message">Hello, Dr Golla Sruthi<br>What is the update on Project X?</span>
                                          </div>
                                       </li>
                                       <li class="right">
                                          <img src="assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                                          <div class="chat-info">
                                             <span class="message">Hi, Dr Madhu<br> It is almost completed. I will send you an email later today.</span>
                                          </div>
                                       </li>
                                       <li class="left float-left">
                                          <img src="assets/images/xs/avatar2.jpg" class="rounded-circle" alt="">
